  ...
  <n-card size="large" style="--padding-bottom: 30px">
    ...
    <n-form size="large" :rules="rules" :model="model">
      <n-form-item-row label="Username" path="username">
        <n-input v-model:value="model.username" placeholder="Input your username" @keydown.enter="handleLogin" />
      </n-form-item-row>
      <n-form-item-row label="Password" path="password">
        <n-input v-model:value="model.password" type="password" placeholder="Input your password" @keydown.enter="handleLogin" />
      </n-form-item-row>
    </n-form>
